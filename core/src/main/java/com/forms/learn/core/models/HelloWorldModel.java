...
public class HelloWorldModel {
    ...
    protected void init() {
        ...
        message = "Hello World!\n"
            ...
            +"Current Resource is : "+ currentResource + "\n";
           // + "Resource Resolver getResource : "+ resourceResolver.getResource(currentPagePath) + "\n";
...
//    	   final Iterable<Resource> childPageList = currentResource.getChildren();
...
//			/content/forms-data-poc/language-masters/en
