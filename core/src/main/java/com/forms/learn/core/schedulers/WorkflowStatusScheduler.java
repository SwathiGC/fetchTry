...
import com.forms.learn.core.config.WorkflowStatusConfiguration;
import com.forms.learn.core.services.EmailService;
...
import static com.forms.learn.core.constants.AppConstants.EQUALS;
import static com.forms.learn.core.constants.AppConstants.NEW_LINE;
import static com.forms.learn.core.schedulers.WorkflowStatusScheduler.NAME;

@Component(immediate = true, service = Runnable.class, property = { Constants.SERVICE_ID + EQUALS + NAME })
