...
public class UpdateTagServlet extends SlingSafeMethodsServlet {
	...
	protected void doGet(final SlingHttpServletRequest req, final SlingHttpServletResponse response) {
		//declare resource resolver here.
		ResourceResolver resourceResolver=null;
		try {

			// response.getWriter().println("New Start");
			...
			pageManager.create("/content/forms-data-poc/language-masters/en", "page creation from java", templatePath,
