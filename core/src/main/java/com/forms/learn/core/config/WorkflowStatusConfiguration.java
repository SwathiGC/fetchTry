...
import static com.forms.learn.core.config.WorkflowStatusConfiguration.CONFIGURATION_DESCRIPTION;
import static com.forms.learn.core.config.WorkflowStatusConfiguration.CONFIGURATION_NAME;
...
public @interface WorkflowStatusConfiguration {
	 String CONFIGURATION_NAME = "Workflow Status Configuration";
	    ...
	    String DEFAULT_EMAIL_ADDRESS = "swathigc997@gmail.com";
